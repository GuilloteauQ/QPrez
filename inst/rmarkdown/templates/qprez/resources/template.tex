...
$for(affiliations.authors)$
$if(affiliations.authors.is_presenter)$
\underline{$affiliations.authors.firstname$ \textsc{$affiliations.authors.lastname$}}$sep$,\!\textsuperscript{$affiliations.mark$}
$else$
$affiliations.authors.firstname$ \textsc{$affiliations.authors.lastname$}$sep$,\!\textsuperscript{$affiliations.mark$}
$endif$
$endfor$
$endfor$
}
